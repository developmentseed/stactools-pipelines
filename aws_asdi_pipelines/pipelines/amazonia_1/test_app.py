...
from aws_asdi_pipelines.pipelines import conftest
from aws_asdi_pipelines.pipelines.amazonia_1.app import (
    handler,
...
def test_handler(mock_env,  # pylint: disable=unused-argument
                 sqs_event, get_token, create_item, requests):
    """test_handler."""
