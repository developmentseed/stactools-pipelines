...
from aws_asdi_pipelines.pipelines.aws_noaa_oisst_avhrr_only.collection import (
    create_collection as module_create_collection,
)
from aws_asdi_pipelines.pipelines.aws_noaa_oisst_avhrr_only.collection import handler
